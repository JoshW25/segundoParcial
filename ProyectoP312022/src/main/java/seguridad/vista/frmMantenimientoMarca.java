...
public class frmMantenimientoMarca extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("Estatus marca");
        daoMarca productoDAO = new daoMarca();
        List<clsMarca> producto = productoDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < producto.size(); i++) {
            dato[0] = producto.get(i).getCodigo_marca();
            dato[1] = producto.get(i).getNombre_marca();
            dato[2] = producto.get(i).getEstatus_marca();
    ...
    public void buscarProducto() {
        ...
        daoMarca productoDAO = new daoMarca();
        productoAConsultar.setCodigo_marca(txtbuscado.getText());
        productoAConsultar = productoDAO.query(productoAConsultar);
        txtNombre.setText(productoAConsultar.getNombre_marca());
        txtestatus.setText(productoAConsultar.getEstatus_marca());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        productoAEliminar.setCodigo_marca(txtbuscado.getText());
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        productoAInsertar.setCodigo_marca(txtProveedor.getText());
        productoAInsertar.setNombre_marca(txtNombre.getText());
        productoAInsertar.setEstatus_marca(txtestatus.getText());
...
//        // TODO add your handling code here:
        ...
        productoAActualizar.setCodigo_marca(txtbuscado.getText());
        productoAActualizar.setNombre_marca(txtNombre.getText());
        productoAActualizar.setEstatus_marca(txtestatus.getText());
