...
public class frmMantenimientoLinea extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("Estatus linea");
        daoLinea productoDAO = new daoLinea();
        List<clsLinea> producto = productoDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < producto.size(); i++) {
            dato[0] = producto.get(i).getCodigo_linea();
            dato[1] = producto.get(i).getNombre_linea();
            dato[2] = producto.get(i).getEstaus_linea();
    ...
    public void buscarProducto() {
        clsLinea productoAConsultar = new clsLinea();
        daoLinea productoDAO = new daoLinea();
        productoAConsultar.setCodigo_linea(txtbuscado.getText());
        productoAConsultar = productoDAO.query(productoAConsultar);
        txtNombre.setText(productoAConsultar.getNombre_linea());
        txtestatus.setText(productoAConsultar.getEstaus_linea());
    ...
    private void initComponents() {
        ...
        getContentPane().add(label3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 330, -1, -1));
        ...
        getContentPane().add(txtestatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 140, 220, -1));

        label5.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        label5.setText("Estatus MARCA");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoLinea productoDAO = new daoLinea();
        clsLinea productoAEliminar = new clsLinea();
        productoAEliminar.setCodigo_linea(txtbuscado.getText());
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoLinea productoDAO = new daoLinea();
        clsLinea productoAInsertar = new clsLinea();
        productoAInsertar.setCodigo_linea(txtProveedor.getText());
        productoAInsertar.setNombre_linea(txtNombre.getText());
        productoAInsertar.setEstaus_linea(txtestatus.getText());
...
//        // TODO add your handling code here:
        daoLinea productoDAO = new daoLinea();
       clsLinea productoAActualizar = new clsLinea();
        productoAActualizar.setCodigo_linea(txtbuscado.getText());
        productoAActualizar.setNombre_linea(txtNombre.getText());
        productoAActualizar.setEstaus_linea(txtestatus.getText());
